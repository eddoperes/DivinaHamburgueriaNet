...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class PurchaseOrderEnricher : ContentResponseEnricher<PurchaseOrderDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(PurchaseOrderDTO content, IUrlHelper urlHelper)
        {
            var path = "api/purchaseorders/v1";
