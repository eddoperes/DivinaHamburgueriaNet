...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class MenuItemResaleEnricher : ContentResponseEnricher<MenuItemResaleDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(MenuItemResaleDTO content, IUrlHelper urlHelper)
        {
            var path = "api/menuitemsresale/v1";
