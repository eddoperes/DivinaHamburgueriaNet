...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class MenuEnricher : ContentResponseEnricher<MenuDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(MenuDTO content, IUrlHelper urlHelper)
        {
            var path = "api/menus/v1";
