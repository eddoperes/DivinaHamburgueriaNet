...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class MenuItemRecipeEnricher : ContentResponseEnricher<MenuItemRecipeDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(MenuItemRecipeDTO content, IUrlHelper urlHelper)
        {
            var path = "api/menuitemsrecipe/v1";
