...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class InventoryItemEnricher : ContentResponseEnricher<InventoryItemDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(InventoryItemDTO content, IUrlHelper urlHelper)
        {
            var path = "api/inventoryitems/v1";
