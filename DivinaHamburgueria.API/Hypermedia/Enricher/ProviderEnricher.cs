...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class ProviderEnricher : ContentResponseEnricher<ProviderDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(ProviderDTO content, IUrlHelper urlHelper)
        {
            var path = "api/providers/v1";
