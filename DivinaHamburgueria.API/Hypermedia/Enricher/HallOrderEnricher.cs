...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class HallOrderEnricher : ContentResponseEnricher<HallOrderDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(HallOrderDTO content, IUrlHelper urlHelper)
        {
            var path = "api/hallorders/v1";
