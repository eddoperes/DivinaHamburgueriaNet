...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class InventoryEnricher : ContentResponseEnricher<InventoryDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(InventoryDTO content, IUrlHelper urlHelper)
        {
            var path = "api/inventories/v1";
