...
namespace DivinaHamburgueria.API.Hypermedia.Enricher
{
    ...
    public class UnityEnricher : ContentResponseEnricher<UnityDTO>
    {

        private readonly object _lock = new object();

        protected override Task EnrichModel(UnityDTO content, IUrlHelper urlHelper)
        {
            var path = "api/units/v1";
